...
def newWindow():
    ...
    total = ((s - b) * q) - total_c
    Label(newwin, font="Arial", background="black",fg = "white", text="For Stock: " + str(Stock.get())).grid(row=5, column=4)
    ...
    Label(newwin, font="Arial", text="Total Turnover " + str(total_buy+total_sell)).grid(row=7, column=4, sticky=W)
